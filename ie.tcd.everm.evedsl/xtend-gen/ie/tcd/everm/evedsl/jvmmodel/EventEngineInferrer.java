...
public class EventEngineInferrer {
  ...
  public JvmGenericType inferEventEngine(final Event elem, final IAcceptor<JvmDeclaredType> acceptor, final boolean isPrelinkingPhase) {
    JvmGenericType _xblockexpression = null;
    {
      ...
      if (!matched) {
        if (intpElem instanceof TextParser) {
          final TextParser _textParser = (TextParser)intpElem;
          matched=true;
          JvmField _xblockexpression_1 = null;
          {
            JvmGenericType _inferParser = this.inferParser(_textParser);
            ...
            JvmField _field = this._jvmTypesBuilder.toField(_textParser, "parser", _createTypeRef, _function_2);
            _xblockexpression_1 = (_field);
          }
          _switchResult = _xblockexpression_1;
        }
      }
      if (!matched) {
        if (intpElem instanceof DirectObjectParser) {
          final DirectObjectParser _directObjectParser = (DirectObjectParser)intpElem;
          matched=true;
          JvmTypeReference _type_1 = _directObjectParser.getType();
          JvmField _field = this._jvmTypesBuilder.toField(_directObjectParser, "parser", _type_1);
          _switchResult = _field;
        }
      }
      CollectionExtensions.<JvmField>operator_add(_members_1, _switchResult);
      ...
      JvmOperation _method = this._jvmTypesBuilder.toMethod(_eNull, "init", _newTypeRef_3, _function_2);
      CollectionExtensions.<JvmOperation>operator_add(_members_2, _method);
      EList<DecScope> _decScope_1 = elem.getDecScope();
      final Function1<DecScope,Boolean> _function_3 = new Function1<DecScope,Boolean>() {
      ...
      Iterable<DecScope> _filter = IterableExtensions.<DecScope>filter(_decScope_1, _function_3);
      for (final DecScope decScope : _filter) {
        {
          ...
          JvmOperation _method_1 = this._jvmTypesBuilder.toMethod(scope, _operator_plus, typeListVar, _function_4);
                          ...
                          if (pre instanceof XAssignment) {
                            ...
                            if ((_assignable instanceof XFeatureCall)) {
                              ...
                              CharSequence _xblockexpression_1 = null;
                              {
                                ...
                                String toappear = _name;
                                _builder.newLineIfNotEmpty();
                                _builder.append("\t\t");
                                String _xifexpression = null;
                                boolean _isNullOrEmpty = StringExtensions.isNullOrEmpty(toappear);
                                if (_isNullOrEmpty) {
                                  String _xblockexpression_2 = null;
                                  {
                                    XExpression _value_2 = _xAssignment.getValue();
                                    EventEngineInferrer.this._xbaseCompiler.toJavaExpression(_value_2, appendable);
                    ...
                    for (final DecScope toEnforce : toEnforceList) {
                      {
                        ...
                        JvmTypeReference _realtype = _scope.getRealtype();
                        boolean _operator_equals = ObjectExtensions.operator_equals(_realtype, null);
                        if (_operator_equals) {
                          ...
                          String _xblockexpression_1 = null;
                          {
                            ...
                            JvmTypeReference _realtype_1 = _scope_1.getRealtype();
                            JvmType _type_1 = _realtype_1.getType();
                            im.addImportFor(_type_1);
                            Scope _scope_2 = toEnforce.getScope();
                            JvmTypeReference _realtype_2 = _scope_2.getRealtype();
                            String _simpleName_2 = _realtype_2.getSimpleName();
                            _xblockexpression_1 = (_simpleName_2);
                          }
                          _xifexpression = _xblockexpression_1;
                        }
                        final String typeName = _xifexpression;
                        Scope _scope_3 = toEnforce.getScope();
                        XExpression _expr = _scope_3.getExpr();
                        XExpression _memberCallTarget = ((XMemberFeatureCall) _expr).getMemberCallTarget();
                        final XExpression parentName = _memberCallTarget;
                        Scope _scope_4 = toEnforce.getScope();
                        XExpression _expr_1 = _scope_4.getExpr();
                        JvmIdentifiableElement _feature = ((XMemberFeatureCall) _expr_1).getFeature();
                        String _simpleName_3 = _feature.getSimpleName();
                        final String memberNameGet = _simpleName_3;
      ...
      JvmOperation _method_2 = this._jvmTypesBuilder.toMethod(_eNull_1, this.CAL_VAR, _newTypeRef_5, _function_5);
          ...
          public void apply(final JvmOperation it) {
            {
              ...
              final Function1<ImportManager,CharSequence> _function = new Function1<ImportManager,CharSequence>() {
                  public CharSequence apply(final ImportManager it) {
                    ...
                    {
                      Parser _parser = elem.getParser();
                      if ((_parser instanceof TextParser)) {
                        _builder.append("if(!parser.parse(event.toString()))");
                        _builder.newLine();
                        _builder.append("\t");
                        _builder.append("return false;");
                        _builder.newLine();
                      } else {
                        Parser _parser_1 = elem.getParser();
                        if ((_parser_1 instanceof DirectObjectParser)) {
                          _builder.append("try{parser = (");
                          Parser _parser_2 = elem.getParser();
                          JvmTypeReference _type = ((DirectObjectParser) _parser_2).getType();
                          String _simpleName = _type.getSimpleName();
                          _builder.append(_simpleName, "");
                          _builder.append(") event;}");
                          _builder.newLineIfNotEmpty();
                          _builder.append("catch(Exception e){return false;}");
                          _builder.newLine();
                        }
                      }
                    }
      ...
      JvmOperation _method_3 = this._jvmTypesBuilder.toMethod(_eNull_2, this.INNER_EXECUTE, _newTypeRef_6, _function_6);
          ...
          public void apply(final JvmOperation it) {
            {
              ...
              final Function1<ImportManager,CharSequence> _function = new Function1<ImportManager,CharSequence>() {
                  public CharSequence apply(final ImportManager it) {
                    StringConcatenation _builder = new StringConcatenation();
                    _builder.append("return _execute(event);");
                    _builder.newLine();
                    return _builder;
                  }
                };
      ...
      JvmOperation _method_4 = this._jvmTypesBuilder.toMethod(_eNull_3, this.EXT_EXECUTE, _newTypeRef_7, _function_7);
      ...
      JvmOperation _method_5 = this._jvmTypesBuilder.toMethod(postElem, this.POST_CONDITION, _newTypeRef_8, _function_8);
                ...
                final Function1<ImportManager,CharSequence> _function = new Function1<ImportManager,CharSequence>() {
                    public CharSequence apply(final ImportManager im) {
                      CharSequence _xblockexpression = null;
                      {
                        ...
                        if (!matched) {
                          if (formatter instanceof WordFormatter) {
                            final WordFormatter _wordFormatter = (WordFormatter)formatter;
                            matched=true;
                            StringConcatenation _builder = new StringConcatenation();
                            _builder.append("java.util.Scanner scanner = new java.util.Scanner(text);");
                            _builder.newLine();
                            _builder.append("java.util.ArrayList<String> result = new java.util.ArrayList<String>();");
                            _builder.newLine();
                            _builder.append("while(scanner.hasNext())");
                            _builder.newLine();
                            _builder.append("\t");
                            _builder.append("result.add(scanner.next());");
                            _builder.newLine();
